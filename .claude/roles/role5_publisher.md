...
**Purpose:** Write the completed newsletter HTML file to disk. ROLE_6 handles the completion summary.
...
## Failure Handling
- File write failure → report the error with the attempted path and error details, then stop
