...
- 배경: **항상 삼성전자 갤럭시 기기/제품과 연관된 이미지**를 사용해요(갤럭시 스마트폰·워치·버즈·탭 등). Pexels `samsung galaxy`·`galaxy phone` 등으로 검색해 **갤럭시 단말이 드러나는 컷**을 골라요. ❌ 아이폰·타사 기기, 그리고 갤럭시와 무관한 일반 테크/풍경 사진은 금지(테크 분위기 컷이라도 갤럭시 연관성이 없으면 쓰지 말 것). 이번 주 미사용 이미지 우선.
