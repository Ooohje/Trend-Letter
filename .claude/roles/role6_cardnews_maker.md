...
- 배경: **항상 최신 삼성전자 갤럭시 기기 이미지**를 사용해요(가장 최근 출시된 갤럭시 S 울트라·Z 폴드/플립 등 **최신 플래그십**). **구형 모델(예: Galaxy S22 이하)은 쓰지 말 것** — 항상 그 시점 기준 가장 최신 모델로. Pexels `samsung galaxy s25 ultra`·`galaxy ultra`·`galaxy z fold` 등으로 검색해 **최신 갤럭시 단말이 또렷이 보이는 컷**을 골라요. 투명도는 약 **25~40%**로 낮춰 텍스트 가독성을 확보해요.
  - 현재 고정 asset: `MAHL9KKP9uo` (Galaxy S25 Ultra · Pexels ID 30466736). 더 최신 모델 컷을 찾기 전까지는 이 asset을 재사용해요.
  - ❌ 아이폰·타사 기기, 구형 갤럭시, 갤럭시와 무관한 일반 테크·풍경 사진 금지.
